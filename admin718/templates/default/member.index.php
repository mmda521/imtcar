...
<div class="page">
  ...
  -->
  <div style="text-align:right;"><a class="btns" color="orange" href="javascript:void(0);" id="ncexport"><span><?php echo $lang['nc_export'];?>Excel</span></a></div>
    ...
    <table class="table tb-type2 nobdb">
      <thead>
        <tr class="thead">
          ...
          <th class="align-center" style="display: none"><?php echo $lang['member_index_points']; ?></th>
          <th class="align-center" style="display: none"><?php echo $lang['member_index_prestore'];?></th>
      ...
      <tbody>
        ...
        <tr class="hover member">
          ...
          <td class="align-center" style="display: none"><?php echo $v['member_points']; ?></td>
          <td class="align-center" style="display: none"><p><?php echo $lang['member_index_available'];?>:&nbsp;<strong class="red"><?php echo $v['available_predeposit']; ?></strong>&nbsp;<?php echo $lang['currency_zh']; ?></p>
