...
<div class="page">
  ...
  <form id="grade_form" name="grade_form" method="post" action="index.php?act=kuajing_packing&op=add_save" >
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" id="packing_name" name="packing_name" maxlength="50" class="txt"></td>
