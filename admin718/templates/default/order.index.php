...
<div class="page">
        ...
        <tr>
         ...
         <th><label><?php echo $lang['order_state'];?></label></th>
          ...
          <select name="order_state" class="querySelect">
              ...
              <option value="1" <?php if($_GET['order_state'] == '1'){?>selected<?php }?>><?php echo '部分退款';?></option>
              <option value="2" <?php if($_GET['order_state'] == '2'){?>selected<?php }?>><?php echo '已关闭';?></option>
            </select></td>
          ...
          <th style="display: none"><label><?php echo 推单状态;?></label></th>
  ...
  <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td>
        <ul>
            <li style="color:orange"><?php echo $lang['order_help1'];?>jp</li>
  ...
  <table class="table tb-type2 nobdb">
    <thead>
      <tr class="thead" >
        <th style="color:orange"><?php echo $lang['order_number'];?></th>
        <th><?php echo $lang['store_name'];?></th>
        <th><?php echo $lang['buyer_name'];?></th>
        <th>订单来源</th>
        ...
        <th class="align-center"><?php echo $lang['payment'];?></th>
          <th class="align-center" style="display: none">税金</th>

        <th class="align-center" style="display: none">推单状态</th>
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td style="color:orange"><?php echo $order['buyer_name'];?></td>
        ...
        <td class="align-center" style="color:orange"><?php echo $order['order_amount'];?></td>
        <td class="align-center"><?php echo orderPaymentName($order['payment_code']);?></td>
          <td class="align-center" style="display: none"><?php echo $order['store_tax_total'];?></td>
    ...
    <!--jinp06281616-->
        ...
        <td class="align-center"><?php if($order['refund_state']=='1'){echo '部分退款';}else if($order['refund_state']=='2'){echo '已关闭';}else{echo orderState($order);} ?></td>
