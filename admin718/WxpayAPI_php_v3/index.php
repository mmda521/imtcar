...
<body>
	<div align="center">
        <ul>
            ...
            <li style="background-color:#CDCD00"><a href="/WxpayAPI_php_v3/example/orderquery.php">订单查询</a></li>

            <li style="background-color:orange;"><a href="/WxpayAPI_php_v3/example/customs.php">支付报关</a></li>

            <li style="background-color:#CD3278"><a href="/WxpayAPI_php_v3/example/refund.php">订单退款</a></li>
