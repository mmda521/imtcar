...
<div class="ncc-receipt-info">
  ...
  <?php print_r($output['address_info']);?>
     <?php include template('buy/buy_address.load');?>
   <!-- <ul>
...
//隐藏收货地址列表
function hideAddrList(addr_id,true_name,area_id,address,phone) {
    $('#edit_reciver').show();
	$("#address_id").val(addr_id);
	$("#addr_list").html('<ul><li><span class="true-name">'+true_name+'</span><span id="area_id">'+area_id+'</span><span class="address">'+address+'</span><span class="phone"><i class="icon-mobile-phone"></i>'+phone+'</span></li></ul>');
