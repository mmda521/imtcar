...
<div class="ncc-form-default">
  <form method="POST" id="addr_form" action="index.php">
    ...
    <dl>
      <dt> <i class="required">*</i>收货人身份证号：</dt>
      <dd>
        <input type="text" class="text w200" name="id_card" id="id_card" maxlength="18" value=""/>
      </dd>
    </dl>
    <dl>
    ...
    <dl>
      ...
      <dd>
        <input type="text" class="text w200" name="mob_phone" id="mob_phone" maxlength="11" value=""/>
...
$(document).ready(function(){
    ...
    $('#addr_form').validate({
        ...
        messages : {
            ...
            id_card : {
                required : '<i class="icon-exclamation-sign"></i><?php echo '请填写收货人身份证号';?>',
                minlength: '<i class="icon-exclamation-sign"></i><?php echo '身份证号必须是18位';?>',
                maxlength: '<i class="icon-exclamation-sign"></i><?php echo '身份证号必须是18位';?>'
            },
            area_id : {
    ...
    if ($('#addr_form').valid()){
        ...
        $.post('index.php',datas,function(data){
            if (data.state){
            	...
            	hideAddrList(data.addr_id,true_name,id_card,area_info+'&nbsp;&nbsp;'+address,(mob_phone != '' ? mob_phone : tel_phone));
            }else{
                alert(data.msg);
            }
        },'json');
