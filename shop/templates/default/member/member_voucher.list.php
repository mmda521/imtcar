  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="goods-time"><?php echo date("Y-m-d",$val['voucher_start_date']).'~'.date("Y-m-d",$val['voucher_end_date']-3600*24*1);?></td>
	  ...
	  <span><a href="index.php?act=member_voucher&op=donate&voucher_id=<?php echo $val['voucher_id'];?>" class="btn-green" ><i class="icon-shopping-cart"></i><p>转赠</p></a></span>
