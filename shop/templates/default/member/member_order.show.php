    ...
    <table class="ncm-default-table order">
      ...
      <tbody>
        ...
        <tr class="bd-line">
          ...
          <td class="bdl bdr" rowspan="<?php echo $output['order_info']['goods_count'];?>"><?php if($output['order_info']['refund_state']=='1'){echo '部分退款';}else if($output['order_info']['refund_state']=='2'){echo '已关闭';}else{echo $output['order_info']['state_desc'];}  ?></td>
