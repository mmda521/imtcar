  ...
  <table class="ncm-default-table order">
    ...
    <tbody order_id="" <?php if (!empty($group_info['pay_amount']) && $p == 0) {?> class="pay" <?php }?>>
      ...
      <tr>
        ...
        <td class="bdl" rowspan="<?php echo $order_info['goods_count'];?>"><p><?php if($order_info['refund_state']=='1'){echo '部分退款';}else if($order_info['refund_state']=='2'){echo '已关闭';}else{echo $order_info['state_desc'];}  ?> <?php echo $order_info['evaluation_status'] ? $lang['member_order_evaluated'] : '';?></p>
