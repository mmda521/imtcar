  ...
  <div class="adds">
    ...
    <form method="post" action="index.php?act=member_address&op=address" id="address_form" target="_parent">
      ...
      <dl>
        ...
        <dd>
          <input type="text" class="text w200" name="id_card" maxlength="18" value="<?php echo $output['address_info']['id_card'];?>"/>
        </dd>
      </dl>
      <dl>
      ...
      <dl>
        ...
        <dd>
          <input type="text" class="text w200" name="tel_phone" maxlength="20" value="<?php echo $output['address_info']['tel_phone'];?>"/>
      ...
      <dl>
        ...
        <dd>
          <input type="text" class="text w200" name="mob_phone" maxlength="11" value="<?php echo $output['address_info']['mob_phone'];?>"/>
        </dd>
      </dl>
...
$(document).ready(function(){
    ...
    $('#address_form').validate({
        ...
        messages : {
            ...
            id_card : {
                required : '<?php echo '请填写身份证号';?>',
                minlength: '<?php echo '身份证号必须是18位';?>',
                maxlength: '<?php echo '身份证号必须是18位';?>'
            },
            area_id : {
