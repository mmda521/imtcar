            ...
            <div id="t" class="ncs-commend-floor">
              ...
              <dl class="detail">
                <dt> <span class="user-name">
                  ...
                  <a href="index.php?act=member_snshome&mid=<?php echo $v['geval_frommemberid'];?>" target="_blank" data-param="{'id':<?php echo $v['geval_frommemberid'];?>}" nctype="mcard"></a><?php echo hideStar($v['geval_frommembername']);?>
                  </span>
