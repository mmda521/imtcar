        ...
        <ul>
          ...
          <li>
            <dl>
              ...
              <dd class="goods-info"><span class="price"><i><?php echo $lang['currency'];?></i> <?php echo $value['goods_promotion_price']?> </span> <span class="goods-sold"><?php echo $lang['show_store_index_be_sold'];?><strong><?php echo $value['goods_salenum']+$value['goods_presalenum'];?></strong> <?php echo $lang['nc_jian'];?></span></dd>
