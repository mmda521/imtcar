...
<div class="ncs-sidebar-container ncs-class-bar" style="display: none">
  <div class="title">
      ...
      <ol>
        ...
        <li>
          <dl>
            ...
            <dd class="selled pngFix"><?php echo $lang['nc_sell_out'];?><strong><?php echo $val['goods_salenum']+$val['goods_presalenum'];?></strong><?php echo $lang['nc_bi'];?></dd>
          </dl>
        </li>
        <?php }?>
      </ol>
