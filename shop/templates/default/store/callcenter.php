...
<div class="ncs-message-bar">
  <div class="default">
     <!--jinp修改店铺字体大小  style="font-size:15px"-->
    <h5><a href="<?php echo urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']), $output['store_info']['store_domain']);?>" title="进入店铺" style="font-size:15px; color:orange" ><?php echo $output['store_info']['store_name']; ?></a></h5>
      ...
      <div class="pj_info">
          <?php  foreach ($output['store_info']['store_credit'] as $value) {?>
            <div class="shopdsr_item">
                <div class="shopdsr_title"><?php echo $value['text'];?>  
                <span style="font-size:20px; color:orange;float:right "><?php echo $value['credit'];?></span>
                </div>
            </div>
  ...
  <div style="display: none" class="service-list" store_id="<?php echo $output['store_info']['store_id'];?>" store_name="<?php echo $output['store_info']['store_name'];?>">
    ...
    <dl class="workingtime" style="display: none">
