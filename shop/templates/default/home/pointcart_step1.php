        ...
        <div class="ncc-candidate-items">
          ...
          <ul class="receive_add address_item">
            <li style="margin-top:0px;">
              ...
              <input style="display: inline-block;" id="address_<?php echo $val['address_id']; ?>" type="radio" name="address_options" value="<?php echo $val['address_id']; ?>" <?php if ($val['is_default'] == 1) echo 'checked'; ?>/>
