    ...
    <div class="nc-register-layout">
      <div class="left">
        <div class="nc-register-mode">
          <ul class="tabs-nav">
            <li><a href="#default">手机注册<i></i></a></li>
            <?php if (C('sms_register') == 1){?>
            <!--
			<li><a href="#account">账号注册<i></i></a></li>
-->
            <?php } ?>
          </ul>
	      ...
	      <form style="display: none;" id="register_sms_form" class="nc-login-form" method="post" action="<?php echo SHOP_SITE_URL;?>/index.php?act=connect_sms&op=register">
                ...
                <dl>
                  ...
                  <dd>
                    <input type="password" id="sms_password" name="password" class="text w150" value="" />
                  </dd>
                  <span class="note">请设置登录密码。</span>
                </dl>
              <dl>
                  <dt><?php echo '确认密码';?>：</dt>
                  <dd>
                    <input type="password" id="sms_password" name="confirm_password" class="text w150" value=""/>
                  </dd>
                  <span class="note">请再次输入密码确认。</span>
                </dl>
                <dl class="mt15">
            ...
            <?php if (C('sms_register') == 1){?>
            <div id="account" class="tabs-content">
...
$(function(){
	//初始化Input的灰色提示信息  
	$('input[tipMsg]').inputTipText({pwd:'password,password_confirm,confirm_password'});
	//注册方式切换
    ...
    $("#register_form").validate({
        ...
        messages : {
            ...
            password  : {
                ...
                pasw: '<i class="icon-exclamation-sign"></i><?php echo $lang['login_register_username_lettersonly'];?>',
            ...
            confirm_password:{
                required : '<i class="icon-exclamation-sign"></i>请重新输入密码',
                equalTo:'<i class="icon-exclamation-sign"></i>两次输入的密码不一致请重新输入'
            },
            email : {
