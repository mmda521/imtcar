...
<div class="item-publish">
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlShop('store_goods_online', 'edit_save_goods');} else { echo urlShop('store_goods_add', 'save_goods');}?>">
    ...
    <input type="hidden" name="commonid" value="<?php echo $output['engine']['goods_commonid'];?>" />
    ...
    <div class="ncsc-form-goods">
      ...
      <dl>
        <dt>商品卖点恩<?php echo $lang['nc_colon'];?></dt>
        <dd>
      ...
      <!--厂商指导价-->
      <dl>
        <dt><i class="required"></i>厂商指导价(万)<?php echo $lang['nc_colon'];?></dt>
        <dd>
          <input name="g_marketprice" value="<?php echo $output['goods']['goods_marketprice']; ?>" type="text" class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
          <p class="hint"><?php echo $lang['store_goods_index_store_price_help'];?>，此价格仅为市场参考售价，请根据该实际情况认真填写。</p>
        </dd>
      ...
      <!--购车方式-->
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo '购车方式'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <select name="pay_type">
            <?php foreach($output['pay_type'] as $k=>$v) {?>
              <option value="<?php echo $k;?>"<?php if ($output['goods']['pay_type']==$k){ echo 'selected';}?>>
                <?php echo $v;?></option>
            <?php }?>
          </select>
          <span></span>
      ...
      <dl nctype="mode_kuajing"  <?php if ($output['goods']['is_mode'] == 0) {?>style="display:none;"<?php }?>>
       ...
       <dl nctype="mode_kuajing" name="hs" id="hs" <?php if ($output['goods']['is_mode'] == 0) {?>style="display:none;"<?php }?>>
        <dt>
          ...
          HSCODE：</dt>
        <dd>
          <input type="text" name="goods_hs" id="goods_hs" class="text" value="<?php echo $output['goods_kuajingD']['hs']; ?>">
          <span></span>
          <p class="hint">请填写商品hscode</p>
        </dd>
      </dl>
       <dl nctype="mode_kuajing" <?php if ($output['goods']['is_mode'] == 0) {?>style="display:none;"<?php }?>>
        <dt>
      ...
      <h3 id="demo2"><?php echo '车辆基本参数'?></h3>
      <dl style="display: none;">
      ...
      <!--厂商-->
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo '厂商'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_manufacturers" value="<?php echo $output['basic']['car_manufacturers']; ?>" type="text" /><span></span>
        </dd>
      </dl>
      <!--级别-->
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo '级别'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_level" value="<?php echo $output['basic']['car_level']; ?>" type="text" /><span></span>
        </dd>
      </dl>
      <!--发动机-->
      <dl>
        <dt nc_type="no_spec"><?php echo '发动机'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_engine" value="<?php echo $output['basic']['car_engine']; ?>" type="text" /><span></span>
        </dd>
      </dl>
      <!--变速箱-->
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo '变速箱'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_gearbox" value="<?php echo $output['basic']['car_gearbox']; ?>" type="text" /><span></span>
        </dd>
      </dl>
      <!--长宽高-->
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo '长*宽*高'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_longwidehigh" value="<?php echo $output['basic']['car_longwidehigh']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--车身结构-->
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo '车身结构'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_body_structure" value="<?php echo $output['basic']['car_body_structure']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--最高车速-->
      <dl>
        <dt nc_type="no_spec"><?php echo '最高车速(km/h)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_maxspeed" value="<?php echo $output['basic']['car_maxspeed']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--官方0-100km/h加速(s)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '官方0-100km/h加速(s)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="office_accelerate" value="<?php echo $output['basic']['office_accelerate']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--实测0-100km/h加速(s)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '实测0-100km/h加速(s)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="fact_accelerate" value="<?php echo $output['basic']['fact_accelerate']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--实测100-0km/h制动(m)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '实测100-0km/h制动(m)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="fact_brake" value="<?php echo $output['basic']['fact_brake']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--实测油耗(L/100km)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '实测油耗(L/100km)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_fuel" value="<?php echo $output['basic']['car_fuel']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--工信部综合油耗(L/100km)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '工信部综合油耗(L/100km)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_intefuel" value="<?php echo $output['basic']['car_intefuel']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--实测离地间隙(mm)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '实测离地间隙(mm)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="fact_ground_clearance" value="<?php echo $output['basic']['fact_ground_clearance']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--整车质保-->
      <dl>
        <dt nc_type="no_spec"><?php echo '整车质保'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="vehicle_warranty" value="<?php echo $output['basic']['vehicle_warranty']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <h3 id="demo3">车身参数</h3>
      ...
      <!--长度(mm)-->
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo '长度(mm)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_length" value="<?php echo $output['carbody']['car_length']; ?>" type="text" /><span></span>
        </dd>
      </dl>
      <!--宽度(mm)-->
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo '宽度(mm)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_width" value="<?php echo $output['carbody']['car_width']; ?>" type="text" /><span></span>
        </dd>
      </dl>
      <!--高度(mm)-->
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo '高度(mm)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_height" value="<?php echo $output['carbody']['car_height']; ?>" type="text" /><span></span>
        </dd>
      </dl>
      <!--轴距(mm)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '轴距(mm)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_wheelbase" value="<?php echo $output['carbody']['car_wheelbase']; ?>" type="text" /><span></span>
        </dd>
      </dl>
      <!--前轮距(mm)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '前轮距(mm)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="front_track" value="<?php echo $output['carbody']['front_track']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--后轮距(mm)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '后轮距(mm)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="rear_track" value="<?php echo $output['carbody']['rear_track']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--最小离地间隙(mm)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '最小离地间隙(mm)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="min_ground_clearance" value="<?php echo $output['carbody']['min_ground_clearance']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--整备质量(kg)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '整备质量(kg)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="curb_quality" value="<?php echo $output['carbody']['curb_quality']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--车身结构-->
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo '车身结构'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="body_structure" value="<?php echo $output['carbody']['body_structure']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--车门数(个)-->
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo '车门数(个)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_doors_num" value="<?php echo $output['carbody']['car_doors_num']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--座位数(个)-->
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo '座位数(个)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_seats_num" value="<?php echo $output['carbody']['car_seats_num']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--油箱容积(L)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '油箱容积(L)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="fuel_capacity" value="<?php echo $output['carbody']['fuel_capacity']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--行李厢容积(L)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '行李厢容积(L)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_luggage" value="<?php echo $output['carbody']['car_luggage']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
	  
	  
      <h3 id="demo4"><?php echo '汽车发动机参数'?></h3>
      <!--发动机型号-->
      <dl>
        <dt nc_type="no_spec"><?php echo '发动机型号'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_emodel" value="<?php echo $output['engine']['car_emodel']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--排量(mL)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '排量(mL)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_displace" value="<?php echo $output['engine']['car_displace']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--排量(L)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '排量(L)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_displacement" value="<?php echo $output['engine']['car_displacement']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--进气形式-->
      <dl>
        <dt nc_type="no_spec"><?php echo '进气形式'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_airin" value="<?php echo $output['engine']['car_airin']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--气缸排列形式-->
      <dl>
        <dt nc_type="no_spec"><?php echo '气缸排列形式'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_cylinder" value="<?php echo $output['engine']['car_cylinder']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--气缸数(个)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '气缸数(个)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_ncylinders" value="<?php echo $output['engine']['car_ncylinders']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--每缸气门数(个)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '每缸气门数(个)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_npcylinder" value="<?php echo $output['engine']['car_npcylinder']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--压缩比-->
      <dl>
        <dt nc_type="no_spec"><?php echo '压缩比'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_ratio" value="<?php echo $output['engine']['car_ratio']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--配气机构-->
      <dl>
        <dt nc_type="no_spec"><?php echo '配气机构'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_air_supply" value="<?php echo $output['engine']['car_air_supply']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--缸径(mm)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '缸径(mm)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_bore" value="<?php echo $output['engine']['car_bore']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--行程(mm)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '行程(mm)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_stroke" value="<?php echo $output['engine']['car_stroke']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--最大马力(Ps)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '最大马力(Ps)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_mps" value="<?php echo $output['engine']['car_mps']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--最大功率(kW)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '最大功率(kW)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_mkw" value="<?php echo $output['engine']['car_mkw']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--最大功率转速(rpm)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '最大功率转速(rpm)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_mrpm" value="<?php echo $output['engine']['car_mrpm']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--最大扭矩(N·m)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '最大扭矩(N·m)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_mNm" value="<?php echo $output['engine']['car_mNm']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--最大扭矩转速(rpm)-->
      <dl>
        <dt nc_type="no_spec"><?php echo '最大扭矩转速(rpm)'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_mmrpm" value="<?php echo $output['engine']['car_mmrpm']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--发动机特有技术-->
      <dl>
        <dt nc_type="no_spec"><?php echo '发动机特有技术'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_engine_technology" value="<?php echo $output['engine']['car_engine_technology']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--燃料形式-->
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo '燃料形式'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_fuel_form" value="<?php echo $output['engine']['car_fuel_form']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--燃油标号-->
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i><?php echo '燃油标号'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_fuel_label" value="<?php echo $output['engine']['car_fuel_label']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--供油方式-->
      <dl>
        <dt nc_type="no_spec"><?php echo '供油方式'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="car_oil_supply" value="<?php echo $output['engine']['car_oil_supply']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--缸盖材料-->
      <dl>
        <dt nc_type="no_spec"><?php echo '缸盖材料'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="cylinder_head_material" value="<?php echo $output['engine']['cylinder_head_material']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--缸体材料-->
      <dl>
        <dt nc_type="no_spec"><?php echo '缸体材料'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="cylinder_material" value="<?php echo $output['engine']['cylinder_material']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <!--环保标准-->
      <dl>
        <dt nc_type="no_spec"><?php echo '环保标准'.$lang['nc_colon'];?></dt>
        <dd nc_type="no_spec">
          <input name="environmental_standards" value="<?php echo $output['engine']['environmental_standards']; ?>" type="text"  /><span></span>
        </dd>
      </dl>
      <dd style="display: none">
      <dl>
...
*/
      ...
      messages : {
        ...
        //基本参数
       car_manufacturers : {
          required    : '<i class="icon-exclamation-sign"></i>请填写厂商名字'
        },
        car_level : {
          required    : '<i class="icon-exclamation-sign"></i>请填写级别'
        },
        car_gearbox : {
          required    : '<i class="icon-exclamation-sign"></i>请填写变速箱'
        },
        /* car_engine : {
          required    : '<i class="icon-exclamation-sign"></i>请填写发动机'
        },

        car_longwidehigh : {
          required    : '<i class="icon-exclamation-sign"></i>请填写长*宽*高'
        },
        car_body_structure : {
          required    : '<i class="icon-exclamation-sign"></i>请填写车身结构'
        },
        car_maxspeed : {
          required    : '<i class="icon-exclamation-sign"></i>请填写最高车速'
        },
        car_intefuel : {
          required    : '<i class="icon-exclamation-sign"></i>请填写工信部综合油耗(L/100km)'
        },
        vehicle_warranty : {
          required    : '<i class="icon-exclamation-sign"></i>请填写整车质保'
        },*/
        //车身
           car_length : {
          required    : '<i class="icon-exclamation-sign"></i>请填写长度(mm)',
          digits      : '<i class="icon-exclamation-sign"></i>只填写整数'
        },
        car_width : {
          required    : '<i class="icon-exclamation-sign"></i>请填写宽度(mm)',
          digits      : '<i class="icon-exclamation-sign"></i>只填写整数'
        },
        car_height : {
          required    : '<i class="icon-exclamation-sign"></i>请填写高度(mm)',
          digits      : '<i class="icon-exclamation-sign"></i>只填写整数'
        },
        body_structure : {
          required    : '<i class="icon-exclamation-sign"></i>请填写车身结构'
        ...
        car_doors_num : {
          required    : '<i class="icon-exclamation-sign"></i>请填写车门数(个)',
          digits      : '<i class="icon-exclamation-sign"></i>只填写整数'
        },
        car_seats_num : {
          required    : '<i class="icon-exclamation-sign"></i>请填写座位数(个)',
          digits      : '<i class="icon-exclamation-sign"></i>只填写整数'
        },
        /*car_wheelbase : {
          required    : '<i class="icon-exclamation-sign"></i>请填写轴距(mm)'
        },
        curb_quality : {
          required    : '<i class="icon-exclamation-sign"></i>请填写整备质量(kg)'
        },

        fuel_capacity : {
          required    : '<i class="icon-exclamation-sign"></i>请填写油箱容积(L)'
        },*/

        //发动机
        car_fuel_form : {
          required    : '<i class="icon-exclamation-sign"></i>请填写燃料形式'
        },
        car_fuel_label : {
          required    : '<i class="icon-exclamation-sign"></i>请填写燃油标号'
        },
       /* car_displace : {
          required    : '<i class="icon-exclamation-sign"></i>请填写排量(mL)',
          digits      : '<i class="icon-exclamation-sign"></i>只填写整数'
        },
        car_displacement : {
          required    : '<i class="icon-exclamation-sign"></i>请填写排量(L)'
        },
        car_airin : {
          required    : '<i class="icon-exclamation-sign"></i>请填写进气形式'
        },
        car_cylinder : {
          required    : '<i class="icon-exclamation-sign"></i>请填写气缸排列形式'
        },
        car_ncylinders : {
          required    : '<i class="icon-exclamation-sign"></i>请填写气缸数(个)',
          digits      : '<i class="icon-exclamation-sign"></i>只填写整数'
        },
        car_npcylinder : {
          required    : '<i class="icon-exclamation-sign"></i>请填写每缸气门数(个)',
          digits      : '<i class="icon-exclamation-sign"></i>只填写整数'
        },
        car_air_supply : {
          required    : '<i class="icon-exclamation-sign"></i>请填写配气机构'
        },
        car_mps : {
          required    : '<i class="icon-exclamation-sign"></i>请填写最大马力(Ps)',
          digits      : '<i class="icon-exclamation-sign"></i>只填写整数'
        },
        car_mkw : {
          required    : '<i class="icon-exclamation-sign"></i>请填写最大功率(kW)',
          digits      : '<i class="icon-exclamation-sign"></i>只填写整数'
        },
        car_mrpm : {
          required    : '<i class="icon-exclamation-sign"></i>请填写最大功率转速(rpm)',
          digits      : '<i class="icon-exclamation-sign"></i>只填写整数'
        },
        car_mNm : {
          required    : '<i class="icon-exclamation-sign"></i>请填写最大扭矩(N·m)',
          digits      : '<i class="icon-exclamation-sign"></i>只填写整数'
        },
        car_mmrpm : {
          required    : '<i class="icon-exclamation-sign"></i>请填写最大扭矩转速(rpm)',
          digits      : '<i class="icon-exclamation-sign"></i>只填写整数'
        },
        car_engine_technology : {
          required    : '<i class="icon-exclamation-sign"></i>请填写发动机特有技术'
        },

        car_oil_supply : {
          required    : '<i class="icon-exclamation-sign"></i>请填写供油方式'
        },
        cylinder_head_material : {
          required    : '<i class="icon-exclamation-sign"></i>请填写缸盖材料'
        },
        cylinder_material : {
          required    : '<i class="icon-exclamation-sign"></i>请填写缸体材料'
        },
        environmental_standards : {
          required    : '<i class="icon-exclamation-sign"></i>请填写环保标准'
        },
*/
        //jinp0902 件数
