...
<div id="mask_adv" class="mask_adv"  style="display:none">
  <div class="mask_h">
   ...
   <div>
    <a href="http://www.zosc.com/shop/index.php?act=pointshop&op=index" target="_blank">
...
<div class="home-focus-layout"> <?php echo $output['web_html']['index_pic'];?>
  ...
  <div style="cursor: hand; margin:0; padding:0;" >
      <a href="http://www.zosc.com/shop/?act=search&keyword=卡乐比"><img style="width:230px; height:201px;" src="<?php echo UPLOAD_SITE_URL;?>/shop/common/adimg5.jpg" alt="广告"/></a>
    </div>
    <!--
    ...
    <div class="cmtleft">
      <div id="con">
        <ul>
          ...
          <li>
            <dl>
              <dt class="goods-thumb"> <a target="_blank" href="<?php echo urlShop('goods','index',array('goods_id'=> $v['geval_goodsid']));?>"> <img src="<?php echo strpos($v['goods_pic'],'http')===0 ? $v['goods_pic']:UPLOAD_SITE_URL."/".ATTACH_GOODS."/".$v['geval_storeid']."/".$v['geval_goodsimage'];?>" rel="" data-url="<?php //echo strpos($v['goods_pic'],'http')===0 ? $v['goods_pic']:UPLOAD_SITE_URL."/".ATTACH_GOODS."/".$v['geval_storeid']."/".$v['geval_goodsimage'];?>" title="<?php echo $v['geval_goodsname']; ?>" alt="<?php echo $v['geval_goodsname']; ?>" /> </a> </dt>
              <dd>
