  ...
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlShop('store_goods_online', 'edit_save_goods');} else { echo urlShop('store_goods_add', 'save_goods');}?>">
    ...
    <div class="ncsc-form-goods">
      ...
      <dl nctype="mode_kuajing"  <?php if ($output['goods']['is_mode'] == 0) {?>style="display:none;"<?php }?>>
        ...
        <option>请选择商品原产国</option>
        <option <?php if ($output['goods_kuajingD']['country_origin'] == '韩国') {?>selected="selected"<?php }?>>韩国</option>
        <option <?php if ($output['goods_kuajingD']['country_origin'] == '德国') {?>selected="selected"<?php }?>>德国</option>
        <option <?php if ($output['goods_kuajingD']['country_origin'] == '荷兰') {?>selected="selected"<?php }?>>荷兰</option>
      ...
      <dl nctype="mode_kuajing"  <?php if ($output['goods']['is_mode'] == 0) {?>style="display:none;"<?php }?>>
        ...
        <option>请选择贸易国别</option>
        <option <?php if ($output['goods_kuajingD']['country_trade'] == '韩国') {?>selected="selected"<?php }?>>韩国</option>
        <option <?php if ($output['goods_kuajingD']['country_trade'] == '德国') {?>selected="selected"<?php }?>>德国</option>
        <option <?php if ($output['goods_kuajingD']['country_trade'] == '荷兰') {?>selected="selected"<?php }?>>荷兰</option>
        </select>
      ...
      <dl nctype="mode_kuajing"  <?php if ($output['goods']['is_mode'] == 0) {?>style="display:none;"<?php }?>>
        ...
        <option value="1" <?php if ($output['goods']['goods_shipper_id'] == '1') {?>selected="selected"<?php }?>>The Kyong International</option>
        <option value="2" <?php if ($output['goods']['goods_shipper_id'] == '2') {?>selected="selected"<?php }?>>BIAN COMPANY</option>
        <option value="3" <?php if ($output['goods']['goods_shipper_id'] == '3') {?>selected="selected"<?php }?>>ZZH International Multimodal Transport GmbH</option>
        </select>
          <span></span>
          <p class="hint"></p>
        </dd>
