    ...
    <table class="ncsc-default-table order deliver">
      <tbody>
        ...
        <tr>
          ...
          <a href="index.php?act=store_deliver&op=DorderPush&order_id=<?php echo $output['order_info']['order_id'];?>" nc_type="" target='_blank' dialog_title="电子口岸反馈" dialog_id="orderpush_dzka" uri="index.php?act=store_deliver&op=DorderPush&order_id=<?php echo $output['order_info']['order_id'];?>" dialog_width="550" class="ncsc-btn-mini fr"><i class="icon-edit"></i>电子口岸</a>
          </td>
        </tr>
        -->
                <tr>
