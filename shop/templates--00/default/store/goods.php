    ...
    <div class="ncs-goods-summary">
      ...
      <div class="ncs-meta"> 
        ...
        <dl>
          ...
          <dd class=""><strong>
          <?php if ($output['goods']['promotion_type'] == 'xianshi') {echo $lang['currency'].ncPriceFormat($output['goods']['goods_tax']*$output['goods']['promotion_price']/$output['goods']['goods_price']);}
            else {echo $lang['currency'].ncPriceFormat($output['goods']['goods_tax']);}
          ?>
          </strong></dd>
        </dl>
        <dl class="rate">
      ...
      (<?php if($output['mansong_info']['mansong_gc_id']== 1088){
                     echo '母婴精品类';}
             else if($output['mansong_info']['mansong_gc_id']== 1104){
                     echo '食品饮料类';}
             else if($output['mansong_info']['mansong_gc_id']== 1173){
                     echo '生活家居类';}
             else if($output['mansong_info']['mansong_gc_id']== 1410){
                     echo '美妆个护类';}
             else if($output['mansong_info']['mansong_gc_id']== 1453){
                     echo '营养保健类';}?>)
