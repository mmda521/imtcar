...
(function() {
  ...
  hm.src = "//hm.baidu.com/hm.js?38d73b246cf2d5ef00a86d64c7faa536";
  ...
  <div class="wrapper">
    ...
    <ul class="site-menu">
     ...
     <!--<li><a href="<?php echo urlShop('brand', 'index');?>" <?php if($output['index_sign'] == 'brand' && $output['index_sign'] != '0') {echo 'class="current"';} ?>> <?php echo $lang['nc_brand'];?></a></li>-->
      ...
      <li><a href="<?php echo urlShop('pointshop', 'index');?>" <?php if($output['index_sign'] == 'pointshop' && $output['index_sign'] != '0') {echo 'class="current"';} ?>>领券积分中心</a></li>
      <?php } ?>
      <?php if (C('cms_isuse')){ ?>
      <li><a href="<?php echo urlShop('promotion', 'index');?>" <?php if($output['index_sign'] == 'special' && $output['index_sign'] != '0') {echo 'class="current"';} ?>> 限时折扣</a></li>
      <?php } ?>
