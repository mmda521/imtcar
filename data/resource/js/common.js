...
function sleft() {
    var oDiv = document.getElementById("clickli");
    var tableL = document.getElementById("ltable");
    var tLi = tableL.getElementsByTagName("tr");
    tableL.style.height = tLi.length * 42 + "px";
    var H = 0,iE6;
    var Y = oDiv;
    while(Y) {
        H += Y.offsetTop;
    ...
    if(!iE6){
        window.onscroll = function() {
            ...
            if(s>H-100 && s<tableL.offsetHeight+H-692) {
                oDiv.className="sleft2";
                if(iE6) {
                    oDiv.style.top=(s-H)+"px";
                }
            } else if (s>tableL.offsetHeight+H-692) {
                oDiv.className="sleft3";
            } else {
                oDiv.className="sleft1";
            }
        };
    }
}
...
$(document).ready(function() {
    ...
    $(".ln3").click(function (){
        $('html, body').animate({
            scrollTop: $("#fdj").offset().top-50
        }, 500);
    });
    $(".ln4").click(function (){
        $('html, body').animate({
            scrollTop: $("#bsx").offset().top-50
        }, 500);
    });
    $(".ln5").click(function (){
        $('html, body').animate({
            scrollTop: $("#dpzx").offset().top-60
        }, 500);
    });
    $(".ln6").click(function (){
        $('html, body').animate({
            scrollTop: $("#clzd").offset().top-50
        }, 500);
    });
    $(".ln7").click(function (){
        $('html, body').animate({
            scrollTop: $("#zbdaqzb").offset().top-50
        }, 500);
    });
    $(".ln8").click(function (){
        $('html, body').animate({
            scrollTop: $("#zypz").offset().top-50
        }, 500);
    });
    $(".ln9").click(function (){
        $('html, body').animate({
            scrollTop: $("#dmtpz").offset().top-60
        }, 500);
    });
    $(".ln10").click(function (){
        $('html, body').animate({
            scrollTop: $("#nbpz").offset().top-50
        }, 500);
    });
    $(".ln11").click(function (){
        $('html, body').animate({
            scrollTop: $("#wbfdpz").offset().top-50
        }, 500);
    });
    $(".ln12").click(function (){
        $('html, body').animate({
            scrollTop: $("#ckpz").offset().top-50
        }, 500);
    });
    $(".ln13").click(function (){
        $('html, body').animate({
            scrollTop: $("#dgpz").offset().top-60
        }, 500);
    });
    $(".ln14").click(function (){
        $('html, body').animate({
            scrollTop: $("#blhsj").offset().top-50
        }, 500);
    });
    $(".ln15").click(function (){
        $('html, body').animate({
            scrollTop: $("#gkjpz").offset().top-60
        }, 500);
    });
    $(".ln16").click(function (){
        $('html, body').animate({
            scrollTop: $("#bxkt").offset().top-50
        }, 500);
    });
});